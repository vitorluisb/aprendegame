...
<template>
    ...
    <GuestLayout>
        <h2 class="text-xl font-bold text-slate-900 mb-1">Crie sua conta</h2>
        <p class="text-slate-500 text-sm mb-6">Comece a estudar de forma gamificada hoje.</p>
        ...
        <form class="space-y-4" @submit.prevent="submit">
            <div>
                ...
                <input
                    ...
                    :class="['w-full rounded-lg border px-3 py-2.5 text-sm transition focus:outline-none focus:ring-2 focus:ring-blue-500',
        ...
        <a
            href="/auth/google"
            class="flex w-full items-center justify-center gap-3 rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition"
        >
